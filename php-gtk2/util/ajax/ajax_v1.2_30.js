// ajax_v1.2_30.js
// 2013.3.20
// added support for Joomla 3.0 download
...
check_status[0] = urlbase + 'check_download_status30.php?j='+j10+'&id=0';
check_status[1] = urlbase + 'check_download_status30.php?j='+j15+'&id=1';
check_status[2] = urlbase + 'check_download_status30.php?j='+j16+'&id=2';
check_status[3] = urlbase + 'check_download_status30.php?j='+j17+'&id=3';
check_status[4] = urlbase + 'check_download_status30.php?j='+j25+'&id=4';
check_status[5] = urlbase + 'check_download_status30.php?j='+j30+'&id=5';
...
function prepareLinks() {
  ...
  links[2].onclick = function() {
  	  status[2] = 0;
      displayLoading(document.getElementById('link2'));
      grabFile_base(check_status[2], 2);
      var query = this.getAttribute("href").split("?")[1];
      download_file(query, 2);
      return false;
  };

  links[3].onclick = function() {
  	  status[3] = 0;
      displayLoading(document.getElementById('link3'));
      grabFile_base(check_status[3], 3);
      var query = this.getAttribute("href").split("?")[1];
      download_file(query, 3);
      return false;
  };

  links[4].onclick = function() {
  	  status[4] = 0;
      displayLoading(document.getElementById('link4'));
      grabFile_base(check_status[4], 4);
      var query = this.getAttribute("href").split("?")[1];
      download_file(query, 4);
      return false;
  };

  links[5].onclick = function() {
  	  status[5] = 0;
      displayLoading(document.getElementById('link5'));
      grabFile_base(check_status[5], 5);
      var query = this.getAttribute("href").split("?")[1];
      download_file(query, 5);
      return false;
  };
}
